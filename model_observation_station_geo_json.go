...
// checks if the ObservationStationGeoJson type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObservationStationGeoJson{}
...
type _ObservationStationGeoJson ObservationStationGeoJson
...
func (o ObservationStationGeoJson) ToMap() (map[string]interface{}, error) {
...
func (o *ObservationStationGeoJson) UnmarshalJSON(data []byte) (err error) {
	...
	varObservationStationGeoJson := _ObservationStationGeoJson{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varObservationStationGeoJson)

	if err != nil {
		return err
	}

	*o = ObservationStationGeoJson(varObservationStationGeoJson)
