...
// checks if the AlertGeoJson type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlertGeoJson{}
...
type _AlertGeoJson AlertGeoJson
...
func (o AlertGeoJson) ToMap() (map[string]interface{}, error) {
...
func (o *AlertGeoJson) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertGeoJson := _AlertGeoJson{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAlertGeoJson)

	if err != nil {
		return err
	}

	*o = AlertGeoJson(varAlertGeoJson)
