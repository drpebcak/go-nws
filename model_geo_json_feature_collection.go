...
// checks if the GeoJsonFeatureCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GeoJsonFeatureCollection{}
...
type _GeoJsonFeatureCollection GeoJsonFeatureCollection
...
func (o GeoJsonFeatureCollection) ToMap() (map[string]interface{}, error) {
...
func (o *GeoJsonFeatureCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varGeoJsonFeatureCollection := _GeoJsonFeatureCollection{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGeoJsonFeatureCollection)

	if err != nil {
		return err
	}

	*o = GeoJsonFeatureCollection(varGeoJsonFeatureCollection)
